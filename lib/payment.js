...
var SANDBOX_URLS = {
  ...
  SHORT_URL: 'https://api.mch.weixin.qq.com/sandboxnew/tools/shorturl',
...
var Payment = function(config) {
  ...
  this.URLS = this.sandbox ? SANDBOX_URLS : URLS;
  return this;
};
...
Payment.prototype.unifiedOrder = function(params, callback) {
  ...
  this._signedQuery(this.URLS.UNIFIED_ORDER, params, {
    required: requiredData
  }, callback);
};

Payment.prototype.orderQuery = function(params, callback) {
  this._signedQuery(this.URLS.ORDER_QUERY, params, {
...
Payment.prototype.refund = function(params, callback) {
  ...
  this._signedQuery(this.URLS.REFUND, params, {
    https: true,
...
Payment.prototype.refundQuery = function(params, callback) {
  this._signedQuery(this.URLS.REFUND_QUERY, params, {
...
Payment.prototype.downloadBill = function(params, callback) {
  var self = this;
  this._signedQuery(this.URLS.DOWNLOAD_BILL, params, {
...
Payment.prototype.shortUrl = function(params, callback) {
  this._signedQuery(this.URLS.SHORT_URL, params, {
    required: ['long_url']
  }, callback);
};

Payment.prototype.closeOrder = function(params, callback) {
  this._signedQuery(this.URLS.CLOSE_ORDER, params, {
    required: ['out_trade_no']
  }, callback);
};

Payment.prototype.getSignKey = function(params, callback) {
  if (!this.sandbox) {
    const error = new Error();
    error.name = 'SandboxRequired';
    return callback(error);
  }
  this._signedQuery(this.URLS.GET_SIGN_KEY, params, {
    required: []
  }, callback);
};
